...
var colors = ["#fa6767"];
var dataColors = $("#chart-line-stacked").data('colors');
if (dataColors) {
	colors = dataColors.split(",");
}
...
var colors = ["#fa6767"];
var dataColors = $("#chart-area").data('colors');
if (dataColors) {
	colors = dataColors.split(",");
}
...
var colors = ["#fa6767"];
var dataColors = $("#chart-area-stacked").data('colors');
if (dataColors) {
	colors = dataColors.split(",");
}
...
// chart-step-line
var colors = ["#fa6767"];
var dataColors = $("#chart-step-line").data('colors');
if (dataColors) {
	colors = dataColors.split(",");
}
