...
<div class="order-project-form">
    ...
    <?php echo $form->field($model, 'project_id')->widget(\kartik\select2\Select2::class,[
            'data' => \yii\helpers\ArrayHelper::map(\common\models\Project::find()->active()->all(), 'id', 'title'),
    ]) ?>
